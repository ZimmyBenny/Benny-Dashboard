...
export const navItems: NavItem[] = [
  ...
  { path: '/dj', label: 'DJ', icon: 'equalizer', subItems: [
    { path: '/dj',              label: 'Dashboard',          icon: 'dashboard' },
    { path: '/dj/events',       label: 'Anfragen & Events',  icon: 'event' },
    ...
    { path: '/dj/playlists',    label: 'Playlisten',         icon: 'queue_music' },
  ...
  { path: '/belege', label: 'Belege', icon: 'receipt_long', subItems: [
    ...
    { path: '/belege/fahrten',        label: 'Fahrten',           icon: 'directions_car' },
...
export const pageNames: Record<string, string> = {
  ...
  '/amazon/recherche-wissen':         'Recherche & Wissen',
  '/amazon/keyword-recherche':        'Keyword-Recherche',
