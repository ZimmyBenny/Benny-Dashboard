...
const DISCLAIMER = 'Diese Auflistung dient ausschließlich als Orientierungshilfe für die eigene Buchhaltung und ersetzt keine Steuerberatung. Kilometerpauschale (0,30 €/km, Dienstreisen) und Verpflegungsmehraufwand sind keine Steuerberatung. Vor Einreichung beim Finanzamt bitte mit dem Steuerberater abstimmen.';
    ...
    <PageWrapper>
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '2.5rem 2rem' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ color: 'var(--color-on-surface-variant)', fontSize: '0.875rem' }}>Kilometerpauschale und Verpflegungsmehraufwand</p>
        </div>
        ...
        <div style={{ background: 'var(--color-surface-container)', borderRadius: '0.75rem', padding: '3rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--color-on-surface-variant)' }}>Fahrten-Tabelle aus Events (automatisch) mit CSV-Export folgt in Phase 2.</p>
        </div>
      </div>
    </PageWrapper>
  );
