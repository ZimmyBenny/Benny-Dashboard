  ...
  return (
    <div className="group flex items-center gap-2 py-1.5 pl-2 pr-1"
      ...
      <input
        ...
        style={{
          background: 'color-mix(in srgb, var(--color-surface-container-low) 35%, transparent)',
...
function GroupSection({ group, fields, onTitle, onDeleteGroup, onAddField, onSaveField, onDeleteField }: {
  ...
  return (
    <section className="rounded-xl p-4 flex flex-col gap-2"
      style={{ background: 'color-mix(in srgb, var(--color-surface-container-low) 45%, transparent)', border: '1px solid rgba(255,255,255,0.06)' }}>
